...
"""autogenerated by genpy from mario_kart/itemRequest.msg. Do not edit."""
import codecs
import sys
...
class itemRequest(genpy.Message):
  _md5sum = "eabcf020b6514d3ff27102ac1d24cb0e"
  _type = "mario_kart/itemRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(itemRequest, self).__init__(*args, **kwds)
...
def _get_struct_2f():
    ...
    return _struct_2f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from mario_kart/itemResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class itemResponse(genpy.Message):
  _md5sum = "a0c47a2b42626c8e0bd2a277053c6c62"
  _type = "mario_kart/itemResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
float64 z"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(itemResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.cmd is None:
...
def _get_struct_6d():
    ...
    return _struct_6d
class item(object):
  _type          = 'mario_kart/item'
  _md5sum = '081833b8303250abb8d3090d1d3e17e7'
  _request_class  = itemRequest
  _response_class = itemResponse
