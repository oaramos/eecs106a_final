...
class itemRequest {
  ...
  static Resolve(msg) {
    ...
    const resolved = new itemRequest(null);
...
class itemResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type itemResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type itemResponse
    let len;
    let data = new itemResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new itemResponse(null);
...
module.exports = {
  ...
  datatype() { return 'mario_kart/item'; }
};
